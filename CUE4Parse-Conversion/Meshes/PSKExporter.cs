...
public class PSKExporter: ExporterBase
{
    ...
    public void ExportSkeletalMeshLod(CSkelMeshLod lod, List<CSkelMeshBone> bones, FArchiveWriter Ar, List<MaterialExporter2>? materialExports, FPackageIndex[]? morphTargets, FPackageIndex[] sockets, int lodIndex)
    {
        var share = new CVertexShare();
        var infHdr = new VChunkHeader();
    ...
    public void ExportSkeletonData(FArchiveWriter Ar, List<CSkelMeshBone> bones)
    {
        var boneHdr = new VChunkHeader();
